...
/**
 * Render the Showcase section containing a media mask and content, and attach a scroll-triggered GSAP animation on non-tablet viewports.
 *
 * The component displays a video with an overlaid mask image and a content column with headings and feature highlights.
 * When the viewport is wider than 1024px, a GSAP timeline with a ScrollTrigger is applied to animate the mask image scale and reveal the content during scroll.
 *
